...
import "github.com/hironow/paintress/internal/cmd"
...
import "github.com/hironow/paintress/internal/usecase"
...
import "github.com/hironow/paintress/internal/session"
...
import "github.com/hironow/paintress/internal/platform"
...
import "github.com/hironow/paintress"

// ruleid: layer-no-root-package-import
import pw "github.com/hironow/paintress"
...
// --- Rule: no-import-old-port (pattern-regex, guard against old internal/port) ---
...
import "github.com/hironow/paintress/pkg/something"
...
var badAgg *domain.ExpeditionAggregate

// ruleid: session-no-aggregate-type
func badNewAgg() domain.ExpeditionAggregate { return domain.ExpeditionAggregate{} }

// ok: session-no-aggregate-type
var goodEmitter port.ExpeditionEventEmitter

// --- Rule 20: session-no-aggregate-method-call ---

func badAggCall(p struct{ Aggregate interface{ RecordStart() } }) {
	// ruleid: session-no-aggregate-method-call
	p.Aggregate.RecordStart()
}
