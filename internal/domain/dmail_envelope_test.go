...
func TestParseDMailEnvelope_FixtureSchemaIsHonored(t *testing.T) {
	...
	path := fixturePath(t, "dmail-2026-06-01T10-00-00Z-abc123.yaml")
	...
	// then: every Phase 1 required field is set, nullable markers stay nil.
	want := domain.DMailEnvelope{
		MessageID:      "dmail-2026-06-01T10-00-00Z-abc123",
		SourceTool:     "sightjack",
		TargetTool:     "paintress",
		Kind:           "scan_report",
		BodyPath:       "./dmail-2026-06-01T10-00-00Z-abc123.body.md",
		CreatedAt:      time.Date(2026, 6, 1, 10, 0, 0, 0, time.UTC),
		IdempotencyKey: "sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
	}
...
func TestParseDMailEnvelope_DetectsConsumedEnvelope(t *testing.T) {
	// given: same fixture but with ack_at set (= post-consume state).
...
body_path: ./b.md
created_at: 2026-06-01T10:00:00Z
seen_at: 2026-06-01T10:05:00Z
ack_at: 2026-06-01T10:06:00Z
idempotency_key: sha256:x`
...
func TestParseDMailEnvelope_BodyPathPointsAtPairedFile(t *testing.T) {
	...
	yamlPath := fixturePath(t, "dmail-2026-06-01T10-00-00Z-abc123.yaml")
