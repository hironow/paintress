...
type ProviderAdapterConfig struct { // nosemgrep: domain-primitives.public-string-field-go -- ToolName is a config field for stream events; newtype adds no safety benefit [permanent]
