...
- [self-improvement-loop.md](self-improvement-loop.md) — How paintress participates in the observable self-improvement loop
...
- Claude Code session telemetry: session metadata and MCP wiring are managed under `.expedition/`; the Go CLI data plane does not own model inference logs
